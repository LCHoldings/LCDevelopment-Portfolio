...
const query = groq`*[ _type == "teamMember" && defined(slug.current) ] | order(_createdAt desc)`
...
<template>
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-48 lg:py-14 mx-auto">
        ...
        <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
            ...
            <p class="mt-1 text-neutral-400">All the people working on LC Scripts</p>
        </div>
        <!-- End Title -->
            ...
            <div v-for="member in teamMembers">
                <div
                    ...
                    <div class="flex items-center gap-x-4">
                        <img class="rounded-full size-20" :src="member.logotype"
                    ...
                    <!-- <div class="mt-3 space-x-1">
                        <a v-for="link in member.links"
                            ...
                            :href="link.link">
                            <svg v-if="link.icon == 'discord'" xmlns="http://www.w3.org/2000/svg" width="16"
                            ...
                            <svg v-if="link.icon == 'github'" xmlns="http://www.w3.org/2000/svg" width="16"
                            ...
                            <svg v-if="link.icon == 'website'" xmlns="http://www.w3.org/2000/svg"
