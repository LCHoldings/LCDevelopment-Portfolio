            ...
            <div v-for="member in teamMembers">
                <div
                    ...
                    <div class="flex items-center gap-x-4">
                        <img class="rounded-full size-20" :src="urlFor(member.logotype).url()" alt="Team Member Logo">
                        <div class="grow">
                    ...
                    <div class="mt-3 space-x-1">
                        <a v-if="member.discordLink"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" class="flex-shrink-0 size-3.5"
                                viewBox="0 0 640 512">
                        ...
                        <a v-if="member.websiteLink"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 size-3.5" viewBox="0 0 24 24"
                        ...
                        <a v-if="member.emailLink"
                            class="inline-flex justify-center items-center size-8 text-sm font-semibold rounded-lg border transition-all duration-200 disabled:opacity-50 disabled:pointer-events-none text-neutral-400 border-neutral-700 hover:bg-neutral-700"
                            :href="'mailto:' + member.emailLink">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" width="16">
                                <path stroke-linecap="round" stroke-linejoin="round" class="fill-white"
