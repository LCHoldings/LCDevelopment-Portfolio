...
<template>
    <div class="relative isolate pt-14 px-8">
        ...
        <div class="max-w-2xl py-56">
            <div class="text-left">
                <h1 class="text-6xl font-bold tracking-tight text-white">We turn dreams into reality and beyond!</h1>
                <p class="mt-6 text-lg leading-8 text-white/60">We are passionate about turning your ideas into reality.
